<template>
  <div>
    ...
    <div
      :class="[spaceBg ? '' : 'bg-white', 'df', 'justify-between', 'justify-end-m', 'items-center', 'pa1', 'pl2-m', 'pr2-m', 'z-2', 'fixed', 't0', 'w-100']"
    >
      <a href="/" :class="[css.color, 'tdx', 'relative', 'mr-au']">
        <h1>🛰 Preons</h1>
      </a>

      <nuxt-link to="/learn" :class="['dn', 'dib-m', 'tdx', 'mr1', css.color, 'relative']">Learn</nuxt-link>
